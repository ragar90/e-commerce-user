...
angular.module('eCommerceUserApp')
    .controller('HeaderCtrl', ['$cookieStore', '$routeParams', 'Product', 'Category', 'search', 'Cart', "$location", "sessionService", "$scope", "$rootScope", function($cookieStore, $routeParams, Product, Category, search, Cart, $location, sessionService, $scope, $rootScope) {
        var _this = this;
